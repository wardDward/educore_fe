...
function Layout({ children }: LayoutProps) {
  ...
  return (
    <section className="flex">
      <Sidebar links={links} toggle={toggle} onToggle={onToggle} />
      <main className={`flex flex-col w-full transtion-all duration-300
        ${toggle 
          ? 'md:w-[calc(100%-180px)] lg:w-[calc(100%-250px)] ml-0 md:ml-[180px] lg:ml-[250px] p-2'
